...
import es.jota.gwt.client.widgets.presenter.interfaces.ISuggestSelection;
import es.jota.gwt.client.widgets.presenter.interfaces.ISuggestSuggestion;

public class Suggest extends Composite implements ISuggestSuggestion.Delegate, ISuggestSelection.Delegate, ISelectValue.IDisplay {
	...
	private native void onMouse( Suggest x, Element e )  /*-{
		$wnd.jQuery(e).mouseleave( function() { x.@es.jota.gwt.client.widgets.display.Suggest::keepFocus = false; } );
		$wnd.jQuery(e).mouseenter( function() { x.@es.jota.gwt.client.widgets.display.Suggest::keepFocus = true; } );
	}-*/;
	...
	private native void onScroll( Suggest x, Element e )  /*-{
		$wnd.jQuery(e).scroll( function() { x.@es.jota.gwt.client.widgets.display.Suggest::checkScroll()(); } );
	}-*/;
